...
import com.example.proloy.office_management.Activity.Adapter.UserListingPagerAdapter;
import com.example.proloy.office_management.Activity.util.core.logout.LogoutContract;
import com.example.proloy.office_management.Activity.util.core.logout.LogoutPresenter;
...
//        setSupportActionBar(mToolbar);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_menu_listing, menu);
    ...
    public void onLogoutSuccess(String message) {
        ...
        ActivityChatLogin.startIntent(this,
