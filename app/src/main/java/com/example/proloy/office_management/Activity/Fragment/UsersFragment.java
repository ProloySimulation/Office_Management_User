...
;
        ...
        import com.example.proloy.office_management.Activity.Adapter.UserListingRecyclerAdapter;
        import com.example.proloy.office_management.Activity.Model.User;
        import com.example.proloy.office_management.Activity.UI.ActivityChat;
        import com.example.proloy.office_management.Activity.util.core.users.add.getAll.GetUsersContract;
        import com.example.proloy.office_management.Activity.util.core.users.add.getAll.GetUsersPresenter;
        import com.example.proloy.office_management.Activity.util.ItemClickSupport;
...
public class UsersFragment extends Fragment implements GetUsersContract.View, ItemClickSupport.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
        ActivityChat.startActivity(getActivity(),
