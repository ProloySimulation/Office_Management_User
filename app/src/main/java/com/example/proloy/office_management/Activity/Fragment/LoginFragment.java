...
import com.example.proloy.office_management.Activity.UI.ActivityRegister;
import com.example.proloy.office_management.Activity.UI.UserListingActivity;
import com.example.proloy.office_management.Activity.util.core.login.LoginContract;
import com.example.proloy.office_management.Activity.util.core.login.LoginPresenter;
...
public class LoginFragment extends Fragment implements View.OnClickListener, LoginContract.View {
    ...
    private void onRegister(View view) {
        ActivityRegister.startActivity(getActivity());
    }
